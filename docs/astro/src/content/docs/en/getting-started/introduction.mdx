...
- 🌐 **Breakpoint hiding** — `hidden-md`, `hidden-lg` (not Tailwind-style responsive prefixes)
...
- [Migrating from Tailwind](/en/guides/migration-from-tailwind) — if you're used to Tailwind CSS
