...
| Class | CSS Property | Description |
|-------|--------------|-------------|
| `.overflow-hidden` | `overflow: hidden` | Hide all overflow |
...
```html
<!-- Background overlay -->
<div class="fixed inset-0 z-i-modal overflow-hidden" style="background: rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center">
  <!-- Modal -->
  <div class="bg-white rounded-lg p-6 max-w-lg mx-4" style="max-height: 80vh; overflow-y: auto">
    <h2 class="text-xl font-bold mb-4">Title</h2>
    <p class="text-gray-600 mb-6">
      Long modal content that can scroll...
    </p>
    <button class="bg-primary-500 text-white px-4 py-2 rounded-base">
      Close
    </button>
  </div>
</div>
...
<div class="table w-full border">
  <div class="table-row" style="background: var(--u-gray-50)">
