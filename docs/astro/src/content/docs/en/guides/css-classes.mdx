...
:::tip[Not Tailwind]
If you're used to Tailwind CSS, start with [Migrating from Tailwind](/en/guides/migration-from-tailwind). There is no bare `.rounded` class — use `.rounded`.
:::
...
- Radius: `.rounded-none`, `.rounded-sm`, `.rounded`, `.rounded-lg`, `.rounded-full`
...
<div class="grid grid-columns--1fr-1fr gap-4">
  <div class="p-4 bg-gray-100 rounded">Element 1</div>
  <div class="p-4 bg-gray-100 rounded">Element 2</div>
</div>
```
