...
<div class="flex flex-col gap-4">
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">items-start</div>
  ...
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">items-center</div>
  ...
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">items-end</div>
...
<div class="flex flex-col gap-4">
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">justify-between</div>
  ...
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">justify-center</div>
...
<div class="flex flex-col gap-4">
  ...
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">gap-4 (16px)</div>
  ...
  <div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600); margin-bottom: 0.5rem">gap-8 (32px)</div>
...
<div class="flex items-center justify-center h-48" style="background: var(--u-gray-100); border-radius: 0.5rem; border: 1px solid var(--u-gray-200)">
  <div class="bg-white border border-gray-200 rounded p-6 text-center">
    <div class="font-bold text-gray-900">Centered</div>
    <div style="font-size: 0.875rem; color: var(--u-gray-600)">Flexbox centering</div>
  </div>
</div>
</Demo>
