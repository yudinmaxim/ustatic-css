...
<Demo>
<div class="flex gap-2 flex-wrap">
  <span class="px-2 py-1 bg-primary-100 text-primary-700 rounded text-sm">Primary</span>
  <span class="px-2 py-1 bg-secondary-100 text-secondary-700 rounded text-sm">Secondary</span>
  <span class="px-2 py-1 bg-success-100 text-success-700 rounded text-sm">Success</span>
  <span class="px-2 py-1 bg-info-100 text-info-700 rounded text-sm">Info</span>
  <span class="px-2 py-1 bg-warning-100 text-warning-700 rounded text-sm">Warning</span>
  <span class="px-2 py-1 bg-danger-100 text-danger-700 rounded text-sm">Danger</span>
</div>
</Demo>
