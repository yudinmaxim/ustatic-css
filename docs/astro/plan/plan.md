...
- [ ] **1.1.12** `interactivity` — интерактивность (pointer-events, select)
- [ ] **1.1.13** `scroll` — стилизованный скроллбар
- [ ] **1.1.14** `cursor` — виды курсора
- [ ] **1.1.15** `outline` — обводка
- [ ] **1.1.16** `hidden` — скрытие на брейкпоинтах
...
- [ ] Нужно ли добавить страницу миграции с Tailwind/Bootstrap? → **сделано:** `guides/migration-from-tailwind` (ru + en)
