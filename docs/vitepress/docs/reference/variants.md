...
<div class="color-grid">
  ...
  <ColorSwatch color="primary" shade="300" backgroundClasses="bg-primary-300" textClasses="text-gray-900" />
  <ColorSwatch color="primary" shade="400" backgroundClasses="bg-primary-400" textClasses="text-gray-900" />
  <ColorSwatch color="primary" shade="500" backgroundClasses="bg-primary-500" textClasses="text-gray-900" />
</div>
...
<div class="color-grid">
  ...
  <ColorSwatch color="secondary" shade="300" backgroundClasses="bg-secondary-300" textClasses="text-gray-900" />
  <ColorSwatch color="secondary" shade="400" backgroundClasses="bg-secondary-400" textClasses="text-gray-900" />
  <ColorSwatch color="secondary" shade="500" backgroundClasses="bg-secondary-500" textClasses="text-gray-900" />
</div>
...
<div class="color-grid">
  ...
  <ColorSwatch color="success" shade="300" backgroundClasses="bg-success-300" textClasses="text-gray-900" />
  <ColorSwatch color="success" shade="400" backgroundClasses="bg-success-400" textClasses="text-gray-900" />
  <ColorSwatch color="success" shade="500" backgroundClasses="bg-success-500" textClasses="text-gray-900" />
</div>
...
<div class="color-grid">
  ...
  <ColorSwatch color="info" shade="300" backgroundClasses="bg-info-300" textClasses="text-gray-900" />
  <ColorSwatch color="info" shade="400" backgroundClasses="bg-info-400" textClasses="text-gray-900" />
  <ColorSwatch color="info" shade="500" backgroundClasses="bg-info-500" textClasses="text-gray-900" />
</div>
...
<div class="color-grid">
  ...
  <ColorSwatch color="warning" shade="300" backgroundClasses="bg-warning-300" textClasses="text-gray-900" />
  <ColorSwatch color="warning" shade="400" backgroundClasses="bg-warning-400" textClasses="text-gray-900" />
  <ColorSwatch color="warning" shade="500" backgroundClasses="bg-warning-500" textClasses="text-gray-900" />
</div>
...
<div class="color-grid">
  ...
  <ColorSwatch color="danger" shade="300" backgroundClasses="bg-danger-300" textClasses="text-gray-900" />
  <ColorSwatch color="danger" shade="400" backgroundClasses="bg-danger-400" textClasses="text-gray-900" />
  <ColorSwatch color="danger" shade="500" backgroundClasses="bg-danger-500" textClasses="text-gray-900" />
</div>
...
<div class="flex gap-2 flex-wrap">
  <button class="px-4 py-2 bg-primary-500 text-white rounded-base hover:bg-primary-600 cursor-pointer">
    Primary
  </button>
  <button class="px-4 py-2 bg-secondary-500 text-white rounded-base hover:bg-secondary-600 cursor-pointer">
    Secondary
  </button>
  <button class="px-4 py-2 bg-success-500 text-white rounded-base hover:bg-success-600 cursor-pointer">
    Success
  </button>
  <button class="px-4 py-2 bg-info-500 text-white rounded-base hover:bg-info-600 cursor-pointer">
    Info
  </button>
  <button class="px-4 py-2 bg-warning-500 text-white rounded-base hover:bg-warning-600 cursor-pointer">
    Warning
  </button>
  <button class="px-4 py-2 bg-danger-500 text-white rounded-base hover:bg-danger-600 cursor-pointer">
    Danger
  </button>
</div>
