...
The module provides classes for managing element borders: thickness, color, style, and rounding.
...
<div class="flex gap-4">
  ...
  <div class="border border-dashed p-4 bg-white">border-dashed (dashed)</div>
</div>
```
...
```html
<div class="flex gap-4 flex-wrap">
  <div class="border border-solid p-4 bg-white">solid (default)</div>
  <div class="border border-dashed p-4 bg-white">dashed</div>
  <div class="border border-dotted p-4 bg-white">dotted</div>
</div>
```
...
```html
<button class="border border-primary-500 text-primary-500 px-4 py-2 rounded 
...
<article class="prose">
  ...
  <p>Second paragraph of text after divider...</p>
</article>
```
...
| Category | Classes |
|----------|---------|
| **Thickness** | `border`, `border-0`, `border-1` ... `border-5` |
...
- [Rounding](./rounded.md) — for rounded corners
- [Outline](../outline/index.md) — for element outlines
- [Background](../bg/index.md) — for element backgrounds