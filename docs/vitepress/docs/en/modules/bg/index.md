...
This module provides classes for managing element backgrounds: colors, opacity, and blur.
...
<div class="flex gap-4">
  ...
  <div class="bg-none p-4 border">None</div>
</div>
```

## Background Opacity

Classes for controlling background opacity:
...
- [Text Colors](../typography/) — for text coloring
- [Opacity](../effects/) — for element transparency
- [Borders](../border/) — for adding borders to backgrounds
